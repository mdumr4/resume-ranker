...
class IndexBuilder:
    def __init__(self, output_dir: str = "Trails/Trail_1/index"):
...
if __name__ == "__main__":
    # Path logic
    sample_path = "../../candidates.jsonl" if os.path.exists("../../candidates.jsonl") else "candidates.jsonl"
    
    if not os.path.exists(sample_path):
        logging.error(f"Cannot find {sample_path}")
    else:
        builder = IndexBuilder()
        builder.build_indices(sample_path, max_records=500) # TEST RUN LIMIT
