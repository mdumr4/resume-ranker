...
print("="*60)
print("INITIALIZING SPLADE-ONLY NEURAL RETRIEVAL ENGINE")
print("="*60)
...
print("Fusing Sparse streams via RRF...")
fusion_lists = [
    splade_career_cids, 
    splade_skills_cids, 
    splade_profile_cids, 
...
sub_out = "Trails/Trail_4/submission.csv"
